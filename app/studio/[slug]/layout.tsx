      ...
      >
        ...
        <nav className="flex items-stretch h-full">
          {[
            ...
            { href: `/studio/${slug}/entries`, label: 'Dance Entries' },
            { href: `/studio/${slug}/couples`, label: 'Couple Events' },
            { href: `/studio/${slug}/solos`, label: 'Solo/Show' },
        ...
        <div
          ...
          style={
            pastDeadline
              ...
              : { backgroundColor: '#fffbeb', color: '#92400e', borderBottom: '1px solid #fde68a' }
          }
        >
          {pastDeadline
            ? 'Entries are closed — the deadline has passed. Contact Jordan for changes.'
            : `Entries close ${settings.entryDeadline.toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })} at ${settings.entryDeadline.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' })}`}
        </div>
      )}
